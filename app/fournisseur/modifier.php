...
if (isset($_POST['modifier'])) :
    ...
    $query = "UPDATE fournisseur SET  `nom`= '$nom', `prenom` = '$prenom', `telephone` = '$telephone', `ville` = '$ville', `email`= '$email' WHERE id= '$idform'";
    $run = mysqli_query($connect, $query);
    if ($run) {
    ...
    <div class="row my-4">
        <div class="col-md-8 mx-auto">
            <div class="card bg-secondary ">
                <div class="card-header text-white">modifier fournisseur</div>
                <div class="card-body bg-light">
                    ...
                    if (isset($_GET['message']) && $_GET['message'] == 'modifier') :
                        echo "<div class='alert alert-success'>le fournisseur a été modifié</div>";
                    endif;
